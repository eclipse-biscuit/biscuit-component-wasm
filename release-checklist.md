...
biscuit-component-wasm is part of the [Eclipse Biscuit](https://projects.eclipse.org/projects/technology.biscuit) project and as such needs to conform the eclipse project management guidelines.
...
- make sure dependency license information is correctly vetted, **both for the crate and the npm package**:
...
- biscuit-component-wasm (this repo)
